      ...
      <div className="container" style={{ padding: '60px 20px', minHeight: '80vh', marginTop: '32px' }}>
        <div className="row">
          ...
          <div className="col-lg-7 col-md-7 col-12">
            <h3 className="font-weight-bold mb-5" style={{ color: '#2D2928', fontSize: '30px' }}>About Us</h3>
            ...
            <div style={{ position: "relative" }} className="mb-5">
              ...
              <div style={{ paddingLeft: '67px', paddingTop: '28px', position: 'relative' }}>
                <h6 className="text-uppercase mb-3 font-weight-bold" style={{ color: '#E93172', letterSpacing: '1px', fontSize: '13px' }}>
                  Technology
                </h6>
                <h4 className="font-weight-bold mb-4" style={{ width: '80%', color: '#2D2928', fontSize: '20px', lineHeight: '1.4' }}>
          ...
          <div className="row w-100 m-0 text-center">
            <div className="col-md-4 col-12 info-item-ourdreams-store mb-3 mb-md-0">
              <div className="d-flex align-items-center justify-content-center">
                ...
                <div className="text-left">
                  <h5 className="font-weight-bold text-uppercase mb-1" style={{ fontSize: '14px', color: '#2D2928' }}>free shipping</h5>
            ...
            <div className="col-md-4 col-12 info-item-ourdreams-store mb-3 mb-md-0">
              <div className="d-flex align-items-center justify-content-center">
                ...
                <div className="text-left">
                  <h5 className="font-weight-bold text-uppercase mb-1" style={{ fontSize: '14px', color: '#2D2928' }}>24/7 support</h5>
            ...
            <div className="col-md-4 col-12 info-item-ourdreams-store">
              <div className="d-flex align-items-center justify-content-center">
                ...
                <div className="text-left">
                  <h5 className="font-weight-bold text-uppercase mb-1" style={{ fontSize: '14px', color: '#2D2928' }}>100% money back</h5>
