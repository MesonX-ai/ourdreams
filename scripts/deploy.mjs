// scripts/deploy.mjs — FTP deploy of out/ + php/ to public_html.
...
// Mirrors out/ -> public_html and php/ -> public_html/api, removes stale
// files, and never touches wp/.
...
const REMOTE_WEB = process.env.FTP_REMOTE_WEB || "public_html";
